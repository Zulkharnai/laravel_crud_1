...
<body>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        ...
                        var name = response[i].employee_name;
                        var email = response[i].employee_email;
                        var address = response[i].employee_address;
                        var phone = response[i].employee_phone;
                        tr += '<tr>';
                        tr += '<td>' + id + '</td>';
                        tr += '<td>' + name + '</td>';
                        tr += '<td>' + email + '</td>';
        ...
        function addEmployee() {
            var employee_name = $('.add_epmployee #name_input').val();
            var employee_email = $('.add_epmployee #email_input').val();
            var employee_phone = $('.add_epmployee #phone_input').val();
            var employee_address = $('.add_epmployee #address_input').val();
        ...
        function editEmployee() {
            var employee_name = $('.edit_employee #name_input').val();
            var employee_email = $('.edit_employee #email_input').val();
            var employee_phone = $('.edit_employee #phone_input').val();
            var employee_address = $('.edit_employee #address_input').val();
        ...
        function viewEmployee(id = 2) {
            $.ajax({
                ...
                success: function(response) {
                    console.log(response);
                    $('.edit_employee #name_input').val(response.employee_name);
                    $('.edit_employee #email_input').val(response.employee_email);
                    $('.edit_employee #phone_input').val(response.employee_phone);
                    $('.edit_employee #address_input').val(response.employee_address);
                    $('.edit_employee #id').val(response.id);
                    $('.view_employee #name_input').val(response.employee_name);
                    $('.view_employee #email_input').val(response.employee_email);
                    $('.view_employee #phone_input').val(response.employee_phone);
                    $('.view_employee #address_input').val(response.employee_address);
                }
            })
        }
